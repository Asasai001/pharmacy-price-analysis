...
class ManoVaistineSpider(scrapy.Spider):
    ...
    def parse_product_page(self, response):
        ...
        product_item["direct_discount_raw"] = product.css('div.item-voucher-blob-text::text').get()
        product_item["conditional_discount_raw"] = product.css('div.item-voucher-blob-text span').xpath('following-sibling::text()[1]').get()
